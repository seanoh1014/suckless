...
static const char *fonts[]          = { "Nerd Font:size=10:weight=bold:antialias=true:autohint:true" };
static const char dmenufont[]       = "Nerd Font:size=10:antialias=true:autohint=true monospace:size=10";
...
static const Key keys[] = {
	...
	{ 0, XK_F3,	spawn,		SHCMD("xbacklight -inc 1") },
        { 0, XK_F2,	spawn,		SHCMD("xbacklight -dec 1") },
